...
export const ExperienceSection: React.FC = () => {
  const experiences = [
    {
      ...
      period: "2021 - Present",
      description: "Leading development of microservices architecture, implementing CI/CD pipelines, and mentoring junior developers.",
      achievements: [
    ...
    },
    {
      ...
      company: "Startup Hub",
      period: "2016 - 2018",
      description: "Worked on frontend development and API integration for an early-stage startup.",
      achievements: [
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-bold text-terminal-green">Work Experience</h2>
      
      <div className="space-y-6">
        {experiences.map((experience, idx) => (
          <div key={idx} className="glass-panel p-4">
            <div className="flex items-start">
              <Terminal className="text-terminal-amber mr-2 mt-1 flex-shrink-0" size={20} />
              <div>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <h3 className="text-lg font-bold text-terminal-amber">{experience.title}</h3>
                  <span className="text-sm text-terminal-green">{experience.period}</span>
                </div>
                
                <div className="text-terminal-blue mt-1">{experience.company}</div>
                <p className="text-terminal-text mt-2">{experience.description}</p>
                
                <div className="mt-3">
                  <p className="text-terminal-comment mb-1">$ cat achievements.log</p>
      ...
      <p className="text-terminal-comment italic">Type 'skills' to see my technical expertise or 'projects' to view my portfolio.</p>
    </div>
  );
};
